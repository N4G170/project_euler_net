...
class ServerSocketUDP
{
	private:
        ...
        */
		...
		UDPpacket* m_udp_list_packet_out;//send list client
	...
	public:
		...
		ServerSocketUDP(unsigned int port, unsigned int packet_size, ProblemsResults* results);
		...
		*/
		...
		void SendList(IPaddress client_ip);
};
